...
//$query : what you searching for 
$names = explode(" " , $query); //seperate queries with space Omaer Aghbar


//strpos($query , '_') look inside the query and find underscore _
if(strpos($query,"_") !== false){
	$userLoggedIn = mysqli_query($con , "SELECT * FROM users WHERE username LIKE '$query%' AND user_closed='no' LIMIT 8");
}
